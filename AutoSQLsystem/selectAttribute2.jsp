...
<%
        ...
        {       
	            ...
	            PreparedStatement ps1 = con.prepareStatement("SELECT  column_name, data_type FROM USER_TAB_COLUMNS WHERE table_name ='"+tableName+"'");
	            /* ps1.setString(1, tableName); */
	            System.out.println("SELECT  column_name, data_type FROM USER_TAB_COLUMNS WHERE table_name ='"+tableName+"'");
	            ...
	            while(rs.next())
	            {
	                ...
	                System.out.println(attributes[count]+types[count]);
	                ++count;
	            }
	            session.setAttribute("tableAtrributes",attributes);
	            session.setAttribute("attributeTypes",types);
	            int i;
%>
...
<script>
	function confirm()
	{
	    if(count > 0)
	    {
	        document.attributeForm.action="operations2";
	        return true;
	    }
	    else
	    {
